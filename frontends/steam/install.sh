...
cp "$CURRENT_ABSOLUTE_DIR/configs/controllers/Icons/*.png" "$STEAM_CONTROLLERS_DIR/es-de/Icons"
cp "$CURRENT_ABSOLUTE_DIR/configs/controllers/*.vdf" "$STEAM_CONTROLLERS_DIR/es-de"

#shortcuts
mkdir -p "$STEAM_CONFIG_DIR/grid"
cp "$CURRENT_ABSOLUTE_DIR/configs/grid/*.png" "$STEAM_CONFIG_DIR/grid"
cp "$CURRENT_ABSOLUTE_DIR/configs/grid/*.ico" "$STEAM_CONFIG_DIR/grid"
